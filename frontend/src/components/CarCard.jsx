...
const CarCard = ({ car, toggleWishlist, wishlist }) => {
  ...
  return (
    <div className="border p-4 rounded-xl shadow-lg bg-white hover:shadow-2xl transition-all duration-300">
      {/* Image Container */}
      ...
      {/* Car Details */}
      <h2 className="font-semibold text-xl mt-4 mb-2">{car.name}</h2>
      <p className="text-gray-600 mb-1">Brand: {car.brand}</p>
      <p className="text-gray-800 font-bold mb-3">Price: ${car.price}</p>
